...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <base href="/frontend/">
        ...
        <!-- <link rel="shortcut icon" href="frontend_2/img/favicon.png"> -->
		...
		<!-- Font Awesome CSS-->
        <link rel="stylesheet" href="frontend_2/css/font-awesome.min.css">
        <!-- Normalize/Reset CSS-->
		<link rel="stylesheet" href="frontend_2/css/normalize.min.css">
		<!-- Main CSS-->
        <link rel="stylesheet" href="frontend_2/css/main.css">
    ...
    <body id="welcome">
		    ...
		    <div class="main-content">
		        ...
		        <section id="css-structure">
		            ...
		            <pre class="brush: html">
					    ...
					    <link rel="stylesheet" href="frontend_2/css/animate.css">
					    <link rel="stylesheet" href="frontend_2/css/owl.carousel.min.css">
					    <link rel="stylesheet" href="frontend_2/css/themify-icons.css">
					    <link rel="stylesheet" href="frontend_2/css/flaticon.css">
					    <link rel="stylesheet" href="frontend_2/css/magnific-popup.css">
					    <link rel="stylesheet" href="frontend_2/css/slick.css">
		        ...
		        <section id="javascript">
		            ...
		            <pre class="brush: html">
						...
						JavaScripts
						========================== -->
					    <script src="frontend_2/js/jquery-1.12.1.min.js"></script>
		    		    <script src="frontend_2/js/popper.min.js"></script>
		    			<script src="frontend_2/js/bootstrap.min.js"></script>
		    			<script src="frontend_2/js/jquery.magnific-popup.js"></script>
		    			<script src="frontend_2/js/swiper.min.js"></script>
		    			<script src="frontend_2/js/masonry.pkgd.js"></script>
		    			<script src="frontend_2/js/owl.carousel.min.js"></script>
		    			<script src="frontend_2/js/jquery.nice-select.min.js"></script>
		    			<script src="frontend_2/js/slick.min.js"></script>
		    			<script src="frontend_2/js/jquery.counterup.min.js"></script>
		    			<script src="frontend_2/js/waypoints.min.js"></script>
		    			<script src="frontend_2/js/custom.js"></script>
		            </pre>
		        </section>
		...
		==============================================-->
        <script type="text/javascript" src="frontend_2/js/jquery-1.11.0.min.js"></script>
        <script type="text/javascript" src="frontend_2/js/jquery.nav.js"></script>
        ...
        <script type="text/javascript" src="frontend_2/js/custom.js"></script>
