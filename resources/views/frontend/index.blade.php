                ...
                <div class="banner_text">
                    <div class="banner_text_iner">
                        ...
                        <p>Replenish seasons may male hath fruit beast were seas saw you arrie said man beast whales
                            ...
                            man</p>
                        <a href="/product" class="btn_1">Khóa học </a>
                        <a href="/contact" class="btn_2">Bắt đầu </a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Giới thiệu chung về chúng tôi, vì sao chọn chúng tôi-->
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-4">
                <div class="single_special_cource">
                    ...
                    <div class="special_cource_text">
                        <a href="/product/detail" class="btn_4">Web Development</a>
                        <h4>$130.00</h4>
                        <a href="/product/detail"><h3>Web Development</h3></a>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="single_special_cource">
                    ...
                    <div class="special_cource_text">
                        <a href="/product/detail" class="btn_4">design</a>
                        <h4>$160.00</h4>
                        <a href="/product/detail"> <h3>Web UX/UI Design </h3></a>
                        <p>Which whose darkness saying were life unto fish wherein all fish of together called</p>
                        <div class="author_info">
                            <div class="author_img">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="single_special_cource">
                    ...
                    <div class="special_cource_text">
                        <a href="/product/detail" class="btn_4">Wordpress</a>
                        <h4>$140.00</h4>
                        <a href="/product/detail">  <h3>Wordpress Development</h3> </a> 
                        <p>Which whose darkness saying were life unto fish wherein all fish of together called</p>
                        <div class="author_info">
                            <div class="author_img">
